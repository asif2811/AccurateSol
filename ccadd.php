...
$costalias = $_POST['costalias'];





$dup = mysqli_query($con,"select * from costmast where costname ='$costname'");
...
$query = "INSERT INTO costmast (costname,costcode,costalias) VALUES ('$costname','$costcode','$costalias')";
  ...
  <div class="row">
    <div class="form-group" style="margin: 10px;">
      <label>Costcenter Name</label>
       <input type="text" name="costname" style="margin-left: 10px;">
      <label style="margin-left: 80px;">Costcenter Code</label>
        <input type="text" name="costcode" style="margin-left: 10px; width: 182px;">
            
      <label style="margin-left: 80px;">Costcenter Alias</label>
      <input type="text" name="costalias" style="margin-left: 10px;">
    </div>
  </div>
