...
<div class="container-fluid" style="margin-left: 180px; margin-top: 35px;">
  <div class="row">
    <div class="form-group">
      <label style="margin-left: 20px;">Search</label>
      <input type="text" name="" id="myInput" style="border:1px solid;" placeholder="Enter the Name" onkeyup="myFunction()">
      <input type="button" name="" value="Add Product" onclick="openWin()" style="background: linear-gradient(to bottom, darkgrey, #ffffff); width: 120px;">
  ...
  <table class="table" id="myTable" style="border-bottom: 1px solid; border: 1px solid;  width: 1236px; margin-top: 10px;">
  <thead style="background: darkgrey; color: white; line-height: 15px;">
    <tr>
      ...
      <th scope="col" style="border: 1px solid black;">Product Code</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border: 1px solid black;"><?php echo $res['prodname'] ?></td>
      <td style="border: 1px solid black;"><?php echo $res['prodcode'] ?></td>
      <td style="border: 1px solid black; text-align: center;"><a href="proddel.php?id=<?php echo $res['id']?>"><input type="button" value="Delete" name="id" style="width: 125px;background: linear-gradient(to bottom, darkgrey, #ffffff);"></a></td>
      <td style="border: 1px solid black; text-align: center;"><a href="produpdate.php?id=<?php echo $res['id'];?>"><input type="button" value="Edit" name="" style="width: 125px;background: linear-gradient(to bottom, darkgrey, #ffffff);"></a></td>
    </tr>
