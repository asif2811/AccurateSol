...
<div class="container-fluid" style="margin-left: 180px; margin-top: 30px;">
  <div class="row">
    <div class="form-group">
      ...
      <input type="button" name="" value="Add Site" onclick="openWin()" style="background: linear-gradient(to bottom, darkgrey, #ffffff);width: 125px;">
  ...
  <thead style="background: darkgrey; color: white; line-height: 15px;">
    <tr>
      ...
      <th scope="col" style="border: 1px solid black;">Site Name</th>
      <th scope="col" style="border: 1px solid black;">Site Code</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border: 1px solid black;"><?php echo $res['sitename'] ?></td>
      <td style="border: 1px solid black;"><?php echo $res['sitecode'] ?></td>
      <td style="border: 1px solid black; text-align: center;"><a href="sitedel.php?id=<?php echo $res['id']?>"><input type="button" value="Delete" name="id" style="width: 125px;background: linear-gradient(to bottom, darkgrey, #ffffff);"></a></td>
      <td style="border: 1px solid black; text-align: center;"><a href="siteupdate.php?id=<?php echo $res['id'];?>"><input type="button" value="Edit" name="" style="width: 125px;background: linear-gradient(to bottom, darkgrey, #ffffff);"></a></td>
    </tr>
