...
<div class="container-fluid" style="margin-left: 180px; margin-top: 30px;">
  <div class="row">
    <div class="form-group">
      ...
      <input type="button" name="" value="Add Warehouse" onclick="openWin()" style="background: linear-gradient(to bottom, darkgrey, #ffffff);">
  ...
  <thead style="background: darkgrey; color: white; line-height: 15px;">
    <tr>
      ...
      <th scope="col" style="border: 1px solid black;">Warehouse Name</th>
      <th scope="col" style="border: 1px solid black;">Warehouse Code</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border: 1px solid black;"><?php echo $res['whname'] ?></td>
      <td style="border: 1px solid black;"><?php echo $res['whcode'] ?></td>
      <td style="border: 1px solid black; text-align: center;"><a href="whdel.php?id=<?php echo $res['id']?>"><input type="button" value="Delete" name="id" style="width: 125px;background: linear-gradient(to bottom, darkgrey, #ffffff);"></a></td>
      <td style="border: 1px solid black; text-align: center;"><a href="whupdate.php?id=<?php echo $res['id'];?>"><input type="button" value="Edit" name="" style="width: 125px;background: linear-gradient(to bottom, darkgrey, #ffffff);"></a></td>
    </tr>
