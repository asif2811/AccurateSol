...
if (count($_POST)!=0)
{
	extract($_POST);
	extract($_GET);
	$queryupdate = "UPDATE tree SET catname = '$catname', catgroup = '$catgroup' WHERE id='$id'";
...
<table class="table" style="margin-left: 175px;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="main.php"><input type="button" class="btn btn-primary" value="Add" name=""></a></td>
