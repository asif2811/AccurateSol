...
$id = $_GET['id'];
$selectquery = "select * from sitemast where id = $id";
...
if (count($_POST)!=0)
{
  extract($_POST);
  extract($_GET);
  $queryupdate = "UPDATE sitemast SET sitename = '$sitename', sitecode = '$sitecode', sitealias = '$sitealias' WHERE id='$id'";
  ...
  <div class="row">
    <div class="form-group" style="margin: 10px;">
      <label>Site Name</label>
       <input type="text" name="sitename" value="<?php echo $updresult['sitename'] ?>" style="margin-left: 10px;">
      <label style="margin-left: 80px;">Costcenter Code</label>
        <input type="text" name="sitecode" value="<?php echo $updresult['sitecode'] ?>"style="margin-left: 10px; width: 182px;">
            
      <label style="margin-left: 80px;">Costcenter Alias</label>
      <input type="text" name="sitealias" value="<?php echo $updresult['sitealias'] ?>" style="margin-left: 10px;">
    </div>
  </div>
